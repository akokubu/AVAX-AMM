...
import { ammSol } from "../typechain-types/contracts";
...
describe("AMM", function () {
  ...
  describe("provide", function () {
    it("Token should be moved", async function () {
      ...
      // 100 ether (= 100 * 10^18)分をprovideするという意味
  ...
  describe("getWithdrawEstimate", function () {
    it("Shoud get the right number of estimated amount", async function () {
      const {
        amm,
        token0,
        amountOtherProvided0,
